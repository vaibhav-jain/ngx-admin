...
var DaLoginComponent = /** @class */ (function () {
  function DaLoginComponent(service, options, router) {
  ...
  DaLoginComponent.prototype.login = function () {
    var _this = this;
  ...
  DaLoginComponent.prototype.getConfigValue = function (key) {
    return getDeepFromObject(this.options, key, null);
  };
  DaLoginComponent.decorators = [
    { type: Component, args: [{
      selector: 'da-login',
      template: "\n" +
      " <da-auth-block>\n" +
  ...
  /** @nocollapse */
  DaLoginComponent.ctorParameters = function () { return [
    { type: NbAuthService, },
    { type: undefined, decorators: [{ type: Inject, args: [NB_AUTH_OPTIONS,] },] },
    { type: Router, },
  ]; };
  return DaLoginComponent;
}());
export { DaLoginComponent };
