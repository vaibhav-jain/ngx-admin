...
var DaAuthBlockComponent = /** @class */ (function () {
    function DaAuthBlockComponent() {
    }
    DaAuthBlockComponent.decorators = [
        { type: Component, args: [{
                    selector: 'da-auth-block',
    ...
    return DaAuthBlockComponent;
}());
export { DaAuthBlockComponent };
